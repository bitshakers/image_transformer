...
const header_data = require(__dirname + '/header_data');
var startOffset;
var endOffset;
var pixel;
...
//   fs.writeFile(__dirname + '/../images/' + unique + '.bmp', data);
// };
var startStop = module.exports = exports = function(data, bitmapHeaders){
  console.log('bitmapHeaders ' + bitmapHeaders.fileSize);
...
function redscale(data, endOffset) {
  for (var i = 54; i < endOffset; i += 4) {
    data.writeUInt8(0);
