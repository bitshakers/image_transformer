...
const startStop = require(__dirname + '/transforms');
...
header_data.run = function() {
  ...
  ee.on('headers', (data) => {
    ...
    startStop(data, header_data.bitmapHeaders);
    return data;
  });
...
//process.argv[2] = file for transforms
//process.argv[3] = transform to apply
//LE BRGA
//BE AGRB
